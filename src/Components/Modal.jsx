...
function Modal({ children, closeModal, onSave, isGrid1, toggleGrid }) {
    return (
        <div className="fixed inset-0 z-50 bg-gray-800 md:flex items-center justify-center h-screen bg-opacity-75 px-4 py-4">
            <div className="bg-[#333] rounded-lg max-w-xl h-[500px] overflow-y-auto pb-4 sm:w-full sm:max-w-md duration-300 flex flex-col"> {/* Modified */}
                ...
                <div className="mt-4 px-2 flex-grow"> {/* Modified */}
