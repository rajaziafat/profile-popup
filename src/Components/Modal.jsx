...
function Modal({ children, closeModal, onSave }) {
    return (
        <div className="fixed inset-0 z-50 overflow-auto bg-gray-800 md:flex items-center justify-center  bg-opacity-75 px-4">

            <div className="bg-[#333] bg-opacity-20 rounded-lg pb-6  max-w-[1200px] h-auto">
